...
const aqiRef = ref(database, "sensor2/aqi");
const pm25Ref = ref(database, "sensor2/pm25");
const pm10Ref = ref(database, "sensor2/pm10");
const coRef = ref(database, "sensor2/co");
const co2Ref = ref(database, "sensor2/co2");  // Replaced SO2 with CO2

// Add these references
const predictionRefs = [
    ref(database, "predictions2/avg1"),
    ref(database, "predictions2/avg2"),
    ref(database, "predictions2/avg3"),
    ref(database, "predictions2/avg4"),
    ref(database, "predictions2/avg5"),
    ref(database, "predictions2/avg6"),
	ref(database, "predictions2/avg7"),
	ref(database, "predictions2/avg8"),
	ref(database, "predictions2/avg9"),
	ref(database, "predictions2/avg10"),
	ref(database, "predictions2/avg11"),
	ref(database, "predictions2/avg12")
];
