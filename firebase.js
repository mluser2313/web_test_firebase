...
const predictionRefs = [
	...
	ref(database, "predictions/avg7"),
	ref(database, "predictions/avg8"),
	ref(database, "predictions/avg9"),
	ref(database, "predictions/avg10"),
	ref(database, "predictions/avg11"),
	ref(database, "predictions/avg12")
];
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/web_test_firebase/service-worker.js')
